/* Finding Top 10 movies using SPARK SQL */
    ...
    val t10DF01 = dfReader01.option("header","true").csv("spark/Data/rating-csv.data")
    t10DF01.printSchema
    val t10DF02 = t10DF01.select(t10DF01.col("mid"), t10DF01.col("rating").cast("double"))
    t10DF02.show(3)
    ...
    t10AvgSorted.show
    val t10movieDF01 = dfReader01.option("header","true").csv("spark/Data/movies-csv.item")
